...
WORK_SYSTEM_SCHEMA_VERSION = "1.0.0"
SUPPORTED_SCHEMA_VERSIONS = {SCHEMA_VERSION, WORK_SCHEMA_VERSION, WORK_SYSTEM_SCHEMA_VERSION}
SUPPORTED_DOMAINS = {"VISITORS", "SERIALS"}
BACKUP_DOMAINS = {"VISITORS", "SERIALS", "FULL", "WORK", "WORK_SYSTEM"}
SERVER_RESTORE_DOMAINS = {"VISITORS", "SERIALS", "FULL", "WORK", "WORK_SYSTEM"}
